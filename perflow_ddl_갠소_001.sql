...
-- 테이블 데이터 perflow.approve_line:~6 rows (대략적) 내보내기
...
INSERT INTO `approve_line` (`approve_line_id`, `doc_id`, `create_user_id`, `group_id`, `name`, `description`, `approve_template_type`, `approve_line_order`, `pll_group_id`, `approve_type`, `status`, `create_datetime`, `complete_datetime`, `update_datetime`) VALUES
	(1, 1, '23-MK004', '1', NULL, NULL, 'MANUAL', 1, NULL, 'SEQ', 'PENDING', '2024-12-12 14:39:59', NULL, '2024-12-12 14:39:59'),
	(2, NULL, '23-MK004', '2', '인사부 기본 결재선', '인사부 결재선입니다.', 'MY_APPROVE_LINE', 1, 1, 'PLL', 'PENDING', '2024-12-12 14:45:55', NULL, '2024-12-12 14:45:55'),
	(3, NULL, '23-MK004', '2', '인사부 기본 결재선', '인사부 결재선입니다.', 'MY_APPROVE_LINE', 2, NULL, 'CC', 'PENDING', '2024-12-12 14:45:55', NULL, '2024-12-12 14:45:55'),
	(4, NULL, '23-MK004', '3', '인사부 기본 결재선2', '인사부 결재선입니다.', 'MY_APPROVE_LINE', 1, NULL, 'SEQ', 'PENDING', '2024-12-12 14:49:41', NULL, '2024-12-12 14:49:41'),
	(5, NULL, '23-MK004', '3', '인사부 기본 결재선2', '인사부 결재선입니다.', 'MY_APPROVE_LINE', 1, 1, 'PLLAGR', 'PENDING', '2024-12-12 14:49:41', NULL, '2024-12-12 14:49:41'),
	(6, NULL, '23-MK004', '3', '인사부 기본 결재선2', '인사부 결재선입니다.', 'MY_APPROVE_LINE', 2, NULL, 'AGR', 'PENDING', '2024-12-12 14:49:41', NULL, '2024-12-12 14:49:41');
...
-- 테이블 데이터 perflow.approve_sbj:~8 rows (대략적) 내보내기
...
INSERT INTO `approve_sbj` (`approve_sbj_id`, `approve_line_id`, `sbj_user_id`, `dept_id`, `sbj_department_pic`, `sbj_type`, `is_pll`, `status`, `complete_datetime`, `create_datetime`, `update_datetime`, `comment`) VALUES
	(1, 1, '23-IT003', NULL, NULL, 'EMPLOYEE', 0, 'ACTIVATED', NULL, '2024-12-12 14:39:59', '2024-12-12 14:39:59', NULL),
	(2, 2, '23-HR001', NULL, NULL, 'EMPLOYEE', 1, 'ACTIVATED', NULL, '2024-12-12 14:45:55', '2024-12-12 14:45:55', NULL),
	(3, 2, '23-IT003', NULL, NULL, 'EMPLOYEE', 1, 'ACTIVATED', NULL, '2024-12-12 14:45:55', '2024-12-12 14:45:55', NULL),
	(4, 3, NULL, 3, NULL, 'DEPARTMENT', 0, 'ACTIVATED', NULL, '2024-12-12 14:45:55', '2024-12-12 14:45:55', NULL),
	(5, 4, '23-IT003', NULL, NULL, 'EMPLOYEE', 0, 'ACTIVATED', NULL, '2024-12-12 14:49:41', '2024-12-12 14:49:41', NULL),
	(6, 5, '23-MK004', NULL, NULL, 'EMPLOYEE', 1, 'ACTIVATED', NULL, '2024-12-12 14:49:41', '2024-12-12 14:49:41', NULL),
	(7, 5, '23-IT003', NULL, NULL, 'EMPLOYEE', 1, 'ACTIVATED', NULL, '2024-12-12 14:49:41', '2024-12-12 14:49:41', NULL),
	(8, 6, '23-MK004', NULL, NULL, 'EMPLOYEE', 0, 'ACTIVATED', NULL, '2024-12-12 14:49:41', '2024-12-12 14:49:41', NULL);
...
CREATE TABLE IF NOT EXISTS `doc` (
  ...
  `title` varchar(50) NOT NULL,
  `content` longtext NOT NULL COMMENT 'JSON 사용 예정',
...
-- 테이블 데이터 perflow.doc:~1 rows (대략적) 내보내기
DELETE FROM `doc`;
INSERT INTO `doc` (`doc_id`, `create_user_id`, `template_id`, `title`, `content`, `status`, `create_datetime`, `update_datetime`, `collect_datetime`, `draft_datetime`) VALUES
	(1, '23-MK004', 13, '2024_12_10_초과근로신청서_마케팅부_최마케팅', '초과 근로 신청합니다.', 'ACTIVATED', '2024-12-12 14:39:59', '2024-12-12 14:39:59', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `doc_field` (
  ...
  `template_field_id` bigint(20) NOT NULL,
  `user_value` longtext NOT NULL,
  `create_datetime` datetime NOT NULL,
  `update_datetime` datetime DEFAULT NULL,
  ...
  CONSTRAINT `doc_field_ibfk_2` FOREIGN KEY (`template_field_id`) REFERENCES `template_field` (`template_field_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- 테이블 데이터 perflow.doc_field:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 perflow.doc_share_obj:~3 rows (대략적) 내보내기
...
INSERT INTO `doc_share_obj` (`doc_share_obj`, `doc_id`, `share_obj_user_id`, `share_obj_department_id`, `share_add_user_id`, `share_obj_type`, `status`, `create_datetime`, `update_datetime`) VALUES
	(1, 1, NULL, 3, '23-MK004', 'DEPARTMENT', 'ACTIVATED', '2024-12-12 14:39:59', '2024-12-12 14:39:59'),
	(2, 1, NULL, 4, '23-MK004', 'DEPARTMENT', 'ACTIVATED', '2024-12-12 14:39:59', '2024-12-12 14:39:59'),
	(3, 1, '23-OP005', NULL, '23-MK004', 'EMPLOYEE', 'ACTIVATED', '2024-12-12 14:39:59', '2024-12-12 14:39:59');
...
INSERT INTO `employee` (`emp_id`, `position_id`, `job_id`, `dept_id`, `password`, `name`, `gender`, `rrn`, `pay`, `address`, `contact`, `email`, `join_date`, `status`, `create_datetime`, `update_datetime`, `resign_date`) VALUES
	('23-FN002', 3, 5, 2, NULL, '이재무', 'Female', '880305-2345678', 60000000, '부산광역시 해운대구', '010-2345-6789', 'finance.lee@example.com', '2023-02-10', 'ACTIVE', '2023-02-10 11:00:00', NULL, NULL),
	('23-HR001', 2, 3, 1, NULL, '김인사', 'Male', '900101-1234567', 50000000, '서울특별시 강남구', '010-1234-5678', 'hr.kim@example.com', '2023-01-15', 'ACTIVE', '2023-01-15 10:00:00', NULL, NULL),
	('23-IT003', 4, 7, 3, NULL, '박IT', 'Male', '950710-3456789', 70000000, '인천광역시 미추홀구', '010-3456-7890', 'it.park@example.com', '2023-03-20', 'ACTIVE', '2023-03-20 12:30:00', NULL, NULL),
	('23-MK004', 4, 9, 4, NULL, '최마케팅', 'Female', '920201-4567890', 45000000, '대구광역시 달서구', '010-4567-8901', 'marketing.choi@example.com', '2023-04-25', 'ACTIVE', '2023-04-25 14:00:00', NULL, NULL),
	('23-OP005', 5, 11, 5, NULL, '정운영', 'Male', '870620-5678901', 55000000, '대전광역시 서구', '010-5678-9012', 'operations.jung@example.com', '2023-05-15', 'ACTIVE', '2023-05-15 09:00:00', NULL, NULL);
...
-- 테이블 데이터 perflow.kpi_limit:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 perflow.template:~12 rows (대략적) 내보내기
...
-- 테이블 perflow.template_field 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `template_field` (
  ...
  `create_datetime` datetime NOT NULL,
  `update_datetime` datetime DEFAULT NULL,
  `status` varchar(30) NOT NULL DEFAULT 'ACTIVATED' COMMENT 'ACTIVATED, DELETED,',
  PRIMARY KEY (`template_field_id`),
  KEY `FK_template_TO_template_field_1` (`template_id`),
  KEY `fk_field_type` (`field_type_id`),
  CONSTRAINT `FK_template_TO_template_field_1` FOREIGN KEY (`template_id`) REFERENCES `template` (`template_id`),
  CONSTRAINT `fk_field_type` FOREIGN KEY (`field_type_id`) REFERENCES `field_type` (`field_type_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- 테이블 데이터 perflow.template_field:~88 rows (대략적) 내보내기
DELETE FROM `template_field`;
INSERT INTO `template_field` (`template_field_id`, `template_id`, `field_type_id`, `field_order`, `details`, `is_repeated`, `create_datetime`, `update_datetime`, `status`) VALUES
	(1, 3, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-05 12:40:48', '2024-12-06 14:59:19', 'DELETED'),
	(2, 3, 3, 2, '{}', 0, '2024-12-05 12:40:48', '2024-12-06 14:59:19', 'DELETED'),
	(3, 3, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-05 12:40:48', '2024-12-06 14:59:19', 'DELETED'),
	(4, 3, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-05 12:40:48', '2024-12-06 14:59:19', 'DELETED'),
	(5, 3, 3, 5, '{}', 0, '2024-12-05 12:40:48', '2024-12-06 14:59:19', 'DELETED'),
	(6, 3, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-05 12:40:48', '2024-12-06 14:59:19', 'DELETED'),
	(7, 4, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-05 12:43:11', '2024-12-06 15:37:30', 'DELETED'),
	(8, 4, 3, 2, '{}', 0, '2024-12-05 12:43:11', '2024-12-06 15:37:30', 'DELETED'),
	(9, 4, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-05 12:43:11', '2024-12-06 15:37:30', 'DELETED'),
	(10, 4, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-05 12:43:11', '2024-12-06 15:37:30', 'DELETED'),
	(11, 4, 3, 5, '{}', 0, '2024-12-05 12:43:11', '2024-12-06 15:37:30', 'DELETED'),
	(12, 4, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-05 12:43:11', '2024-12-06 15:37:30', 'DELETED'),
	(13, 5, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-05 12:43:15', '2024-12-06 15:37:30', 'DELETED'),
	(14, 5, 3, 2, '{}', 0, '2024-12-05 12:43:15', '2024-12-06 15:37:30', 'DELETED'),
	(15, 5, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-05 12:43:15', '2024-12-06 15:37:30', 'DELETED'),
	(16, 5, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-05 12:43:15', '2024-12-06 15:37:30', 'DELETED'),
	(17, 5, 3, 5, '{}', 0, '2024-12-05 12:43:15', '2024-12-06 15:37:30', 'DELETED'),
	(18, 5, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-05 12:43:15', '2024-12-06 15:37:30', 'DELETED'),
	(19, 5, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 14:22:50', '2024-12-06 15:37:30', 'DELETED'),
	(20, 5, 3, 2, '{}', 0, '2024-12-06 14:22:50', '2024-12-06 15:37:30', 'DELETED'),
	(21, 5, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 14:22:50', '2024-12-06 15:37:30', 'DELETED'),
	(22, 5, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 14:22:50', '2024-12-06 15:37:30', 'DELETED'),
	(23, 5, 3, 5, '{}', 0, '2024-12-06 14:22:50', '2024-12-06 15:37:30', 'DELETED'),
	(24, 5, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 14:42:07', '2024-12-06 15:37:30', 'DELETED'),
	(25, 5, 3, 2, '{}', 0, '2024-12-06 14:42:07', '2024-12-06 15:37:30', 'DELETED'),
	(26, 5, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 14:42:07', '2024-12-06 15:37:30', 'DELETED'),
	(27, 5, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 14:42:07', '2024-12-06 15:37:30', 'DELETED'),
	(28, 5, 3, 5, '{}', 0, '2024-12-06 14:42:07', '2024-12-06 15:37:30', 'DELETED'),
	(29, 5, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 14:42:07', '2024-12-06 15:37:30', 'DELETED'),
	(30, 5, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 14:44:22', '2024-12-06 15:37:30', 'DELETED'),
	(31, 5, 3, 2, '{}', 0, '2024-12-06 14:44:22', '2024-12-06 15:37:30', 'DELETED'),
	(32, 5, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 14:44:22', '2024-12-06 15:37:30', 'DELETED'),
	(33, 5, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 14:44:22', '2024-12-06 15:37:30', 'DELETED'),
	(34, 5, 3, 5, '{}', 0, '2024-12-06 14:44:22', '2024-12-06 15:37:30', 'DELETED'),
	(35, 6, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 15:38:09', '2024-12-06 15:39:05', 'DELETED'),
	(36, 6, 3, 2, '{}', 0, '2024-12-06 15:38:09', '2024-12-06 15:39:05', 'DELETED'),
	(37, 6, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 15:38:09', '2024-12-06 15:39:05', 'DELETED'),
	(38, 6, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 15:38:09', '2024-12-06 15:39:05', 'DELETED'),
	(39, 6, 3, 5, '{}', 0, '2024-12-06 15:38:09', '2024-12-06 15:39:05', 'DELETED'),
	(40, 6, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 15:38:09', '2024-12-06 15:39:05', 'DELETED'),
	(41, 7, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 15:38:13', '2024-12-06 15:39:11', 'DELETED'),
	(42, 7, 3, 2, '{}', 0, '2024-12-06 15:38:13', '2024-12-06 15:39:11', 'DELETED'),
	(43, 7, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 15:38:13', '2024-12-06 15:39:11', 'DELETED'),
	(44, 7, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 15:38:13', '2024-12-06 15:39:11', 'DELETED'),
	(45, 7, 3, 5, '{}', 0, '2024-12-06 15:38:13', '2024-12-06 15:39:11', 'DELETED'),
	(46, 7, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 15:38:13', '2024-12-06 15:39:11', 'DELETED'),
	(47, 8, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 15:38:16', '2024-12-06 15:39:20', 'DELETED'),
	(48, 8, 3, 2, '{}', 0, '2024-12-06 15:38:16', '2024-12-06 15:39:20', 'DELETED'),
	(49, 8, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 15:38:16', '2024-12-06 15:39:20', 'DELETED'),
	(50, 8, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 15:38:16', '2024-12-06 15:39:20', 'DELETED'),
	(51, 8, 3, 5, '{}', 0, '2024-12-06 15:38:16', '2024-12-06 15:39:20', 'DELETED'),
	(52, 8, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 15:38:16', '2024-12-06 15:39:20', 'DELETED'),
	(53, 9, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 15:38:24', '2024-12-06 15:39:20', 'DELETED'),
	(54, 9, 3, 2, '{}', 0, '2024-12-06 15:38:24', '2024-12-06 15:39:20', 'DELETED'),
	(55, 9, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 15:38:24', '2024-12-06 15:39:20', 'DELETED'),
	(56, 9, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 15:38:24', '2024-12-06 15:39:20', 'DELETED'),
	(57, 9, 3, 5, '{}', 0, '2024-12-06 15:38:24', '2024-12-06 15:39:20', 'DELETED'),
	(58, 9, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 15:38:24', '2024-12-06 15:39:20', 'DELETED'),
	(59, 10, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 16:18:45', '2024-12-06 16:19:31', 'DELETED'),
	(60, 10, 3, 2, '{}', 0, '2024-12-06 16:18:45', '2024-12-06 16:19:31', 'DELETED'),
	(61, 10, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 16:18:45', '2024-12-06 16:19:31', 'DELETED'),
	(62, 10, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 16:18:45', '2024-12-06 16:19:31', 'DELETED'),
	(63, 10, 3, 5, '{}', 0, '2024-12-06 16:18:45', '2024-12-06 16:19:31', 'DELETED'),
	(64, 10, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 16:18:45', '2024-12-06 16:19:31', 'DELETED'),
	(65, 11, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 16:19:01', '2024-12-06 16:19:42', 'DELETED'),
	(66, 11, 3, 2, '{}', 0, '2024-12-06 16:19:01', '2024-12-06 16:19:42', 'DELETED'),
	(67, 11, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 16:19:01', '2024-12-06 16:19:42', 'DELETED'),
	(68, 11, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 16:19:01', '2024-12-06 16:19:42', 'DELETED'),
	(69, 11, 3, 5, '{}', 0, '2024-12-06 16:19:01', '2024-12-06 16:19:42', 'DELETED'),
	(70, 11, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 16:19:01', '2024-12-06 16:19:42', 'DELETED'),
	(71, 12, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 16:19:05', '2024-12-06 16:19:42', 'DELETED'),
	(72, 12, 3, 2, '{}', 0, '2024-12-06 16:19:05', '2024-12-06 16:19:42', 'DELETED'),
	(73, 12, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 16:19:05', '2024-12-06 16:19:42', 'DELETED'),
	(74, 12, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 16:19:05', '2024-12-06 16:19:42', 'DELETED'),
	(75, 12, 3, 5, '{}', 0, '2024-12-06 16:19:05', '2024-12-06 16:19:42', 'DELETED'),
	(76, 12, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 16:19:05', '2024-12-06 16:19:42', 'DELETED'),
	(77, 13, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-06 16:19:09', '2024-12-06 16:19:09', 'ACTIVATED'),
	(78, 13, 3, 2, '{}', 0, '2024-12-06 16:19:09', '2024-12-06 16:19:09', 'ACTIVATED'),
	(79, 13, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-06 16:19:09', '2024-12-06 16:19:09', 'ACTIVATED'),
	(80, 13, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-06 16:19:09', '2024-12-06 16:19:09', 'ACTIVATED'),
	(81, 13, 3, 5, '{}', 0, '2024-12-06 16:19:09', '2024-12-06 16:19:09', 'ACTIVATED'),
	(82, 13, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-06 16:19:09', '2024-12-06 16:19:09', 'ACTIVATED'),
	(83, 14, 1, 1, '{"name": "제목", "isReq": true, "defaultValue": "제목을 입력하세요." }', 0, '2024-12-12 15:00:28', '2024-12-12 15:00:28', 'ACTIVATED'),
	(84, 14, 3, 2, '{}', 0, '2024-12-12 15:00:28', '2024-12-12 15:00:28', 'ACTIVATED'),
	(85, 14, 1, 3, '{"name": "품목", "isReq": true, "defaultValue": "제목을 입력하세요."}', 1, '2024-12-12 15:00:28', '2024-12-12 15:00:28', 'ACTIVATED'),
	(86, 14, 5, 4, '{"name": "지출금액", "isReq": false, "defaultValue": "", "currency": "USD"}', 1, '2024-12-12 15:00:28', '2024-12-12 15:00:28', 'ACTIVATED'),
	(87, 14, 3, 5, '{}', 0, '2024-12-12 15:00:28', '2024-12-12 15:00:28', 'ACTIVATED'),
	(88, 14, 2, 6, '{"name": "사유", "isReq": false, "defaultValue": "내용을 입력하세요."}', 0, '2024-12-12 15:00:28', '2024-12-12 15:00:28', 'ACTIVATED');
...
-- 테이블 데이터 perflow.weight:~1 rows (대략적) 내보내기
DELETE FROM `weight`;
