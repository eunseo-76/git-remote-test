...
-- 테이블 데이터 perflow.approve_line:~18 rows (대략적) 내보내기
...
-- 테이블 데이터 perflow.approve_sbj:~24 rows (대략적) 내보내기
...
INSERT INTO `approve_sbj` (`approve_sbj_id`, `approve_line_id`, `sbj_user_id`, `dept_id`, `sbj_department_pic`, `sbj_type`, `is_pll`, `status`, `complete_datetime`, `create_datetime`, `update_datetime`, `comment`) VALUES
	...
	(44, 39, '23-OP005', NULL, NULL, 'EMPLOYEE', 1, 'APPROVED', NULL, '2024-12-15 00:05:55', '2024-12-15 14:29:08', '다음부터는 제목에 이름 소속 써주세요.'),
...
-- 테이블 데이터 perflow.doc:~6 rows (대략적) 내보내기
DELETE FROM `doc`;
...
-- 테이블 데이터 perflow.doc_field:~16 rows (대략적) 내보내기
...
-- 테이블 데이터 perflow.doc_share_obj:~13 rows (대략적) 내보내기
